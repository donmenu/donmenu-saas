    ...
    <main className="p-4 md:p-10 mx-auto max-w-7xl">
      ...
      <div className="mb-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
          <div>
            <Title className="text-3xl font-bold text-gray-900">Cardápios</Title>
            <Text className="text-gray-600 mt-2">Gerencie os itens do seu cardápio</Text>
          </div>
          <Button
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Card className="bg-gradient-to-br from-green-50 to-green-100 border-0 shadow-lg">
            <Flex alignItems="start">
              <div className="truncate">
                <Text className="text-green-600 font-medium">Total de Itens</Text>
                <Metric className="text-green-900">{totalCardapios}</Metric>
              </div>
          ...
          <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-0 shadow-lg">
            <Flex alignItems="start">
              <div className="truncate">
                <Text className="text-blue-600 font-medium">Itens Ativos</Text>
                <Metric className="text-blue-900">{ativos}</Metric>
              </div>
          ...
          <Card className="bg-gradient-to-br from-orange-50 to-orange-100 border-0 shadow-lg">
            <Flex alignItems="start">
              <div className="truncate">
                <Text className="text-orange-600 font-medium">Itens Inativos</Text>
                <Metric className="text-orange-900">{inativos}</Metric>
              </div>
      ...
      <Card className="bg-white shadow-xl border-0 rounded-xl overflow-hidden">
        <div className="p-6 border-b border-gray-100">
          <Title className="text-xl font-semibold text-gray-800">Lista de Cardápios</Title>
          <Text className="text-gray-600 mt-1">Visualize e gerencie todos os itens do cardápio</Text>
        </div>
        ...
        <div className="p-6">
          {loading ? (
            <div className="flex items-center justify-center py-12">
              ...
              <Text className="ml-3 text-gray-500">Carregando cardápios...</Text>
            </div>
          ) : errorMessage ? (
            ...
            <div className="text-center py-12">
              ...
              <Title className="text-gray-500 mb-2">Nenhum item encontrado</Title>
              <Text className="text-gray-400">Comece adicionando seu primeiro item ao cardápio</Text>
            </div>
          ) : (
