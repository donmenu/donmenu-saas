      ...
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center mb-4">
            ...
            <span className="text-2xl font-bold text-gray-900">Don Menu</span>
          </div>
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Acesse sua conta</h1>
          <p className="text-gray-600">Entre para gerenciar seu restaurante</p>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          <p className="text-xs text-gray-500 text-center">
            ...
            <a href="/termos" className="text-green-600 hover:text-green-700 underline">
              Termos de Uso
            </a>{' '}
            e{' '}
            <a href="/privacidade" className="text-green-600 hover:text-green-700 underline">
